...
* A clean checkout of the source added to a valid [Go
  ...
  *src/example.com/m/v2* (unless you plan to use `AUTO_GOPATH`,
...
* a [properly
  ...
  [is](https://example.com/m/v2/issues/2683)
  [not](https://example.com/m/v2/issues/3485)
  [sufficient](https://example.com/m/v2/issues/4568))
