...
import (
	...
	_ "example.com/m/v2/daemon/graphdriver/vfs" // import the vfs driver so it is used in the tests
	"example.com/m/v2/image"
	"example.com/m/v2/utils"
	"example.com/m/v2/vendor/src/code.google.com/p/go/src/pkg/archive/tar"
	"io"
	"os"
	"path"
	"testing"
